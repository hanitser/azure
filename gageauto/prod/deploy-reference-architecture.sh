...
RESOURCE_GROUP_NAME="gageauto-prod-rg"
LOCATION="centralus"
OS_TYPE="linux"
...
VIRTUAL_NETWORK_DEPLOYMENT_NAME="gageauto-vnet-deployment"
...
AVAILABILITY_SET_DEPLOYMENT_NAME="gageauto-data-avset-deployment"
...
WEB_TIER_DEPLOYMENT_NAME="gageauto-web-deployment"

BIZ_TIER_PARAMETERS_PATH="${SCRIPT_DIR}/parameters/${OS_TYPE}/appsTier.parameters.json"
BIZ_TIER_DEPLOYMENT_NAME="gageauto-app-deployment"

DATA_TIER_PARAMETERS_PATH="${SCRIPT_DIR}/parameters/${OS_TYPE}/dataTier.parameters.json"
DATA_TIER_DEPLOYMENT_NAME="gageauto-data-deployment"
...
NETWORK_SECURITY_GROUP_DEPLOYMENT_NAME="gageauto-nsg-deployment"
...
# Create availability set for MariaDB cluster
