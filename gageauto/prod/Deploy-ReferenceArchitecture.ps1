...
$businessTierParametersFile = [System.IO.Path]::Combine($PSScriptRoot, 'parameters', $OSType.ToLower(), 'appsTier.parameters.json')
...
$resourceGroupName = "gageauto-prod-rg"
...
New-AzureRmResourceGroupDeployment -Name "gageauto-vnet-deployment" -ResourceGroupName $resourceGroup.ResourceGroupName `
...
New-AzureRmResourceGroupDeployment -Name "gageauto-data-avset-deployment" -ResourceGroupName $resourceGroup.ResourceGroupName `
...
New-AzureRmResourceGroupDeployment -Name "gageauto-app-deployment" -ResourceGroupName $resourceGroup.ResourceGroupName `
...
New-AzureRmResourceGroupDeployment -Name "gageauto-data-deployment" -ResourceGroupName $resourceGroup.ResourceGroupName `
    -TemplateUri $virtualMachineTemplate.AbsoluteUri -TemplateParameterFile $dataTierParametersFile

Write-Host "Deploying web tier..."
New-AzureRmResourceGroupDeployment -Name "gageauto-web-deployment" -ResourceGroupName $resourceGroup.ResourceGroupName `
...
New-AzureRmResourceGroupDeployment -Name "gageauto-nsg-deployment" -ResourceGroupName $resourceGroup.ResourceGroupName `
